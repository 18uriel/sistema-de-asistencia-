...
<?php include 'includes/topbar.php';?>
    ...
    <div class="attendance-button">
      <button id="startButton" class="add" >Iniciar Reconocimiento Facial</button>
      <button id="endButton"class="add" style="display:none">Finalizar Proceso de Asistencia</button>
      <button id="endAttendance" class="add" > FINALIZAR la toma de asistencia</button>
    </div>
