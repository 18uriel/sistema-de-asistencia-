            ...
            <ul class="sidebar--items">
                ...
                <li>
                    <a href="takeAttendance.php">
                        ...
                        <span class="sidebar--item">Tomar Asistencia </span>
                    </a>
                </li>
                <li>
                    <a href="viewAttendance.php">
                        <span class="icon icon-1"><i class="ri-map-pin-line"></i></span>
                        <span class="sidebar--item" style="white-space: nowrap;">Ver Asistencia</span>
                    </a>
                </li>
                <li>
                    <a href="viewStudent.php">
                        <span class="icon icon-1"><i class="ri-user-line"></i></span>
                        <span class="sidebar--item">Estudiantes</span>
                    </a>
                </li>
                <li>
                    <a href="downloadRecord.php">
                        <span class="icon icon-1"><i class="ri-user-line"></i></span>
                        <span class="sidebar--item">Descargar Asistencia </span>
                    </a>
                </li>
